            ...
            body: SafeArea(
              child: Column(
                children: [
                  Expanded(
                    child: Stack(
                      children: [
                        ...
                        Container(
                          margin: const EdgeInsets.fromLTRB(20, 40, 20, 10), //흰색 컨테이너 위치 조정 왼쪽부터 좌, 상, 우, 하
                          width: 320,
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Container(                       //프로필이름
                                        ...
                                        margin: const EdgeInsets.fromLTRB(100, 37, 0, 0)
                                    ),


                                    Container(                       //프로필이름 아래 작대기
                                      width: 140,
                                      height: 3,
                                      color: const Color(0xff444d6a),
                                      margin: const EdgeInsets.fromLTRB(100, 68, 0, 0),
                                    ),
                                    ...
                                    Container(                                        //상태메시지
                                      ...
                                      margin: const EdgeInsets.fromLTRB(100, 76, 0, 0),
                                    ),
                                    ...
                                    Container(                         //점 3개
                                      ...
                                      margin: const EdgeInsets.fromLTRB(290, 10, 0, 0),
                                    ),
                                  ],
                                ),
                              ),
                  ...
                  Expanded(
                    child:Container(                        //참여중인 방의 컨테이너가 되는 컨테이너
                      height: 300.0,
                      width: 320.0,
