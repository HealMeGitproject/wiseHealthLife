...
class _ThirdPageState extends State<ThirdPage> {
  ...
  void initState() {
    ...
    _streamSubscription = p.getSnapshot().listen((event) {
      ...
      p.addOne(ChatModel.fromJson(event.docs[0].data() as Map<String, dynamic>));
        ...
        body: Column(
          children: <Widget>[
            Expanded(
              child: ListView(
                reverse: true,
                children: p.ChatList.map((e) => Chatmessage(chatModel: e)).toList(),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<StreamSubscription>('_streamSubscription', _streamSubscription));
  }*/
}
